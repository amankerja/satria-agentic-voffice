...
export const initialMemories: AgentMemoryItem[] = [
  ...
  },
  {
    ...
    type: 'procedural',
    scope: 'employee',
    title: 'JWT Refresh Token Concurrency Mutex Pattern',
    content: 'Pada backend Go Fiber (satria-api) / Node auth handlers, gunakan distributed mutex locking saat melakukan token rotation untuk mencegah race condition dan HTTP 500 saat concurrency spike.',
    tags: ['backend', 'auth', 'jwt', 'concurrency', 'mutex'],
    confidence: 0.98,
    importance: 5,
    source: 'autonomous_run',
    accessCount: 34,
    lastAccessedAt: '2026-08-16T08:00:00Z',
  ...
  },
  {
    ...
    type: 'procedural',
    scope: 'employee',
    title: 'Strict Path Sandboxing Defense & Injection Verification',
    content: 'Selalu sanitasi input path dan query parameter terhadap direktori workspace aktif. Cegah symlink attack dan parameter tampering sebelum memicu tool filesystem atau query database.',
    tags: ['security', 'sandbox', 'filesystem', 'injection_prevention'],
    confidence: 0.99,
    importance: 5,
    source: 'autonomous_run',
    accessCount: 22,
